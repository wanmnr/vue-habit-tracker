...
<template>
  ...
  <div class="form-container">
    <a-form :model="formState" name="basicForm" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" autocomplete="off"
      @finish="onFinish">
      <!-- Text Input -->
      ...
      <a-form-item label="Birth Date" name="birthDate">
        <a-date-picker v-model:value="formState.birthDate" :format="dateFormat" placeholder="Select birth date" />
      </a-form-item>
      ...
      <a-form-item label="Bio" name="bio">
        <a-textarea v-model:value="formState.bio" :rows="4" placeholder="Tell us about yourself" />
      </a-form-item>
